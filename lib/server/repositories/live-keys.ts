...
function normalizeLiveKeyMatchResult(
  value: unknown,
...
function normalizeScoreOverride(value: unknown): ScoreOverride | null {
  ...
  if (
    ...
    typeof raw.playerNickname !== "string"
  )
    return null;
  ...
  return {
    ...
    source:
      raw.source === "auto" || raw.source === "host" ? raw.source : "host",
    confidence:
...
function normalizeWinnerOverride(value: unknown): WinnerOverride | null {
  ...
  if (typeof raw.matchId !== "string" || typeof raw.playerNickname !== "string")
    return null;
...
export function normalizeLiveKeyPayload(value: unknown): CardLiveKeyPayload {
  ...
  return {
    ...
    tiebreakerRecordedAt:
      typeof raw.tiebreakerRecordedAt === "string"
        ? raw.tiebreakerRecordedAt
        : null,
    tiebreakerTimerId:
      typeof raw.tiebreakerTimerId === "string" ? raw.tiebreakerTimerId : null,
...
async function ensureSoloLiveGame(
  cardId: string,
  userId: string,
...
export async function getLiveKeyStateForUser(
  cardId: string,
  userId: string,
): Promise<LiveKeyState | null> {
